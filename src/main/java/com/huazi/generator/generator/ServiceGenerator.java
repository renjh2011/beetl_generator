...
public class ServiceGenerator {
    ...
    public ServiceGenerator(String tableName) throws SQLException, ClassNotFoundException {
        ...
        template.binding("package", servicePackageName);

        //渲染模板
        String entityStr=template.render();

        /** 获取生成文件路径并输出 */
        String path=GeneratorUtil.getClzPath(servicePackageName.replace(".","\\"),serviceName+".java");
